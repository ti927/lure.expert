...
ALTER TABLE documents ADD COLUMN IF NOT EXISTS report_type text NOT NULL DEFAULT 'other';
ALTER TABLE documents ADD COLUMN IF NOT EXISTS reference_date text;
