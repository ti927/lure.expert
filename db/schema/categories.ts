...
export const categories = pgTable(
  'categories',
  {
    ...
    // DRE: receita_operacional | deducoes_tributarias | deducoes_operacionais | cpv | sga | resultado_financeiro | ir | emprestimos_amortizacoes | investimentos_retiradas | transfer
    ...
    opexCapex: text('opex_capex').notNull().default('opex'),
