...
| 3.3 | Ferramentas de escrita com preview→confirm | ◐ máquina pronta (`lib/mcp/preview.ts`) + dois pares: classificação e rateio em lote. Faltam regras, orçamento e importação |
| 4 | Convites e papéis | 🔲 |
