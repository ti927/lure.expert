...
| 3.3 | Ferramentas de escrita com preview→confirm | ◐ máquina pronta (`lib/mcp/preview.ts`) + quatro pares: classificação, rateio, lançamento de orçamento e cópia do realizado. Faltam regras e importação |
| 4 | Convites e papéis | 🔲 |
