...
| 3.2 | Servidor MCP + ferramentas de leitura | ◐ fatia fina no ar: `/api/mcp` + 4 ferramentas (`listar_organizacoes`, `descrever_organizacao`, `consultar`, `explicar_consulta`). Faltam `listar_categorias`, `listar_dimensoes`, `detalhar_lancamentos` e o grupo de dashboard |
